...
namespace Model
{
        ...
        typedef Utils::Outcome<AcceptVpcPeeringConnectionResponse, Client::AWSError<EC2Errors>> AcceptVpcPeeringConnectionOutcome;
        typedef Utils::Outcome<AllocateAddressResponse, Client::AWSError<EC2Errors>> AllocateAddressOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> AssignPrivateIpAddressesOutcome;
        typedef Utils::Outcome<AssociateAddressResponse, Client::AWSError<EC2Errors>> AssociateAddressOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> AssociateDhcpOptionsOutcome;
        typedef Utils::Outcome<AssociateRouteTableResponse, Client::AWSError<EC2Errors>> AssociateRouteTableOutcome;
        typedef Utils::Outcome<AttachClassicLinkVpcResponse, Client::AWSError<EC2Errors>> AttachClassicLinkVpcOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> AttachInternetGatewayOutcome;
        typedef Utils::Outcome<AttachNetworkInterfaceResponse, Client::AWSError<EC2Errors>> AttachNetworkInterfaceOutcome;
        typedef Utils::Outcome<AttachVolumeResponse, Client::AWSError<EC2Errors>> AttachVolumeOutcome;
        typedef Utils::Outcome<AttachVpnGatewayResponse, Client::AWSError<EC2Errors>> AttachVpnGatewayOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> AuthorizeSecurityGroupEgressOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> AuthorizeSecurityGroupIngressOutcome;
        typedef Utils::Outcome<BundleInstanceResponse, Client::AWSError<EC2Errors>> BundleInstanceOutcome;
        typedef Utils::Outcome<CancelBundleTaskResponse, Client::AWSError<EC2Errors>> CancelBundleTaskOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> CancelConversionTaskOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> CancelExportTaskOutcome;
        typedef Utils::Outcome<CancelImportTaskResponse, Client::AWSError<EC2Errors>> CancelImportTaskOutcome;
        typedef Utils::Outcome<CancelReservedInstancesListingResponse, Client::AWSError<EC2Errors>> CancelReservedInstancesListingOutcome;
        typedef Utils::Outcome<CancelSpotFleetRequestsResponse, Client::AWSError<EC2Errors>> CancelSpotFleetRequestsOutcome;
        typedef Utils::Outcome<CancelSpotInstanceRequestsResponse, Client::AWSError<EC2Errors>> CancelSpotInstanceRequestsOutcome;
        typedef Utils::Outcome<ConfirmProductInstanceResponse, Client::AWSError<EC2Errors>> ConfirmProductInstanceOutcome;
        typedef Utils::Outcome<CopyImageResponse, Client::AWSError<EC2Errors>> CopyImageOutcome;
        typedef Utils::Outcome<CopySnapshotResponse, Client::AWSError<EC2Errors>> CopySnapshotOutcome;
        typedef Utils::Outcome<CreateCustomerGatewayResponse, Client::AWSError<EC2Errors>> CreateCustomerGatewayOutcome;
        typedef Utils::Outcome<CreateDhcpOptionsResponse, Client::AWSError<EC2Errors>> CreateDhcpOptionsOutcome;
        typedef Utils::Outcome<CreateFlowLogsResponse, Client::AWSError<EC2Errors>> CreateFlowLogsOutcome;
        typedef Utils::Outcome<CreateImageResponse, Client::AWSError<EC2Errors>> CreateImageOutcome;
        typedef Utils::Outcome<CreateInstanceExportTaskResponse, Client::AWSError<EC2Errors>> CreateInstanceExportTaskOutcome;
        typedef Utils::Outcome<CreateInternetGatewayResponse, Client::AWSError<EC2Errors>> CreateInternetGatewayOutcome;
        typedef Utils::Outcome<CreateKeyPairResponse, Client::AWSError<EC2Errors>> CreateKeyPairOutcome;
        typedef Utils::Outcome<CreateNetworkAclResponse, Client::AWSError<EC2Errors>> CreateNetworkAclOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> CreateNetworkAclEntryOutcome;
        typedef Utils::Outcome<CreateNetworkInterfaceResponse, Client::AWSError<EC2Errors>> CreateNetworkInterfaceOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> CreatePlacementGroupOutcome;
        typedef Utils::Outcome<CreateReservedInstancesListingResponse, Client::AWSError<EC2Errors>> CreateReservedInstancesListingOutcome;
        typedef Utils::Outcome<CreateRouteResponse, Client::AWSError<EC2Errors>> CreateRouteOutcome;
        typedef Utils::Outcome<CreateRouteTableResponse, Client::AWSError<EC2Errors>> CreateRouteTableOutcome;
        typedef Utils::Outcome<CreateSecurityGroupResponse, Client::AWSError<EC2Errors>> CreateSecurityGroupOutcome;
        typedef Utils::Outcome<CreateSnapshotResponse, Client::AWSError<EC2Errors>> CreateSnapshotOutcome;
        typedef Utils::Outcome<CreateSpotDatafeedSubscriptionResponse, Client::AWSError<EC2Errors>> CreateSpotDatafeedSubscriptionOutcome;
        typedef Utils::Outcome<CreateSubnetResponse, Client::AWSError<EC2Errors>> CreateSubnetOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> CreateTagsOutcome;
        typedef Utils::Outcome<CreateVolumeResponse, Client::AWSError<EC2Errors>> CreateVolumeOutcome;
        typedef Utils::Outcome<CreateVpcResponse, Client::AWSError<EC2Errors>> CreateVpcOutcome;
        typedef Utils::Outcome<CreateVpcEndpointResponse, Client::AWSError<EC2Errors>> CreateVpcEndpointOutcome;
        typedef Utils::Outcome<CreateVpcPeeringConnectionResponse, Client::AWSError<EC2Errors>> CreateVpcPeeringConnectionOutcome;
        typedef Utils::Outcome<CreateVpnConnectionResponse, Client::AWSError<EC2Errors>> CreateVpnConnectionOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> CreateVpnConnectionRouteOutcome;
        typedef Utils::Outcome<CreateVpnGatewayResponse, Client::AWSError<EC2Errors>> CreateVpnGatewayOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteCustomerGatewayOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteDhcpOptionsOutcome;
        typedef Utils::Outcome<DeleteFlowLogsResponse, Client::AWSError<EC2Errors>> DeleteFlowLogsOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteInternetGatewayOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteKeyPairOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteNetworkAclOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteNetworkAclEntryOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteNetworkInterfaceOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeletePlacementGroupOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteRouteOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteRouteTableOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteSecurityGroupOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteSnapshotOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteSpotDatafeedSubscriptionOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteSubnetOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteTagsOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteVolumeOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteVpcOutcome;
        typedef Utils::Outcome<DeleteVpcEndpointsResponse, Client::AWSError<EC2Errors>> DeleteVpcEndpointsOutcome;
        typedef Utils::Outcome<DeleteVpcPeeringConnectionResponse, Client::AWSError<EC2Errors>> DeleteVpcPeeringConnectionOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteVpnConnectionOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteVpnConnectionRouteOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeleteVpnGatewayOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DeregisterImageOutcome;
        typedef Utils::Outcome<DescribeAccountAttributesResponse, Client::AWSError<EC2Errors>> DescribeAccountAttributesOutcome;
        typedef Utils::Outcome<DescribeAddressesResponse, Client::AWSError<EC2Errors>> DescribeAddressesOutcome;
        typedef Utils::Outcome<DescribeAvailabilityZonesResponse, Client::AWSError<EC2Errors>> DescribeAvailabilityZonesOutcome;
        typedef Utils::Outcome<DescribeBundleTasksResponse, Client::AWSError<EC2Errors>> DescribeBundleTasksOutcome;
        typedef Utils::Outcome<DescribeClassicLinkInstancesResponse, Client::AWSError<EC2Errors>> DescribeClassicLinkInstancesOutcome;
        typedef Utils::Outcome<DescribeConversionTasksResponse, Client::AWSError<EC2Errors>> DescribeConversionTasksOutcome;
        typedef Utils::Outcome<DescribeCustomerGatewaysResponse, Client::AWSError<EC2Errors>> DescribeCustomerGatewaysOutcome;
        typedef Utils::Outcome<DescribeDhcpOptionsResponse, Client::AWSError<EC2Errors>> DescribeDhcpOptionsOutcome;
        typedef Utils::Outcome<DescribeExportTasksResponse, Client::AWSError<EC2Errors>> DescribeExportTasksOutcome;
        typedef Utils::Outcome<DescribeFlowLogsResponse, Client::AWSError<EC2Errors>> DescribeFlowLogsOutcome;
        typedef Utils::Outcome<DescribeImageAttributeResponse, Client::AWSError<EC2Errors>> DescribeImageAttributeOutcome;
        typedef Utils::Outcome<DescribeImagesResponse, Client::AWSError<EC2Errors>> DescribeImagesOutcome;
        typedef Utils::Outcome<DescribeImportImageTasksResponse, Client::AWSError<EC2Errors>> DescribeImportImageTasksOutcome;
        typedef Utils::Outcome<DescribeImportSnapshotTasksResponse, Client::AWSError<EC2Errors>> DescribeImportSnapshotTasksOutcome;
        typedef Utils::Outcome<DescribeInstanceAttributeResponse, Client::AWSError<EC2Errors>> DescribeInstanceAttributeOutcome;
        typedef Utils::Outcome<DescribeInstanceStatusResponse, Client::AWSError<EC2Errors>> DescribeInstanceStatusOutcome;
        typedef Utils::Outcome<DescribeInstancesResponse, Client::AWSError<EC2Errors>> DescribeInstancesOutcome;
        typedef Utils::Outcome<DescribeInternetGatewaysResponse, Client::AWSError<EC2Errors>> DescribeInternetGatewaysOutcome;
        typedef Utils::Outcome<DescribeKeyPairsResponse, Client::AWSError<EC2Errors>> DescribeKeyPairsOutcome;
        typedef Utils::Outcome<DescribeMovingAddressesResponse, Client::AWSError<EC2Errors>> DescribeMovingAddressesOutcome;
        typedef Utils::Outcome<DescribeNetworkAclsResponse, Client::AWSError<EC2Errors>> DescribeNetworkAclsOutcome;
        typedef Utils::Outcome<DescribeNetworkInterfaceAttributeResponse, Client::AWSError<EC2Errors>> DescribeNetworkInterfaceAttributeOutcome;
        typedef Utils::Outcome<DescribeNetworkInterfacesResponse, Client::AWSError<EC2Errors>> DescribeNetworkInterfacesOutcome;
        typedef Utils::Outcome<DescribePlacementGroupsResponse, Client::AWSError<EC2Errors>> DescribePlacementGroupsOutcome;
        typedef Utils::Outcome<DescribePrefixListsResponse, Client::AWSError<EC2Errors>> DescribePrefixListsOutcome;
        typedef Utils::Outcome<DescribeRegionsResponse, Client::AWSError<EC2Errors>> DescribeRegionsOutcome;
        typedef Utils::Outcome<DescribeReservedInstancesResponse, Client::AWSError<EC2Errors>> DescribeReservedInstancesOutcome;
        typedef Utils::Outcome<DescribeReservedInstancesListingsResponse, Client::AWSError<EC2Errors>> DescribeReservedInstancesListingsOutcome;
        typedef Utils::Outcome<DescribeReservedInstancesModificationsResponse, Client::AWSError<EC2Errors>> DescribeReservedInstancesModificationsOutcome;
        typedef Utils::Outcome<DescribeReservedInstancesOfferingsResponse, Client::AWSError<EC2Errors>> DescribeReservedInstancesOfferingsOutcome;
        typedef Utils::Outcome<DescribeRouteTablesResponse, Client::AWSError<EC2Errors>> DescribeRouteTablesOutcome;
        typedef Utils::Outcome<DescribeSecurityGroupsResponse, Client::AWSError<EC2Errors>> DescribeSecurityGroupsOutcome;
        typedef Utils::Outcome<DescribeSnapshotAttributeResponse, Client::AWSError<EC2Errors>> DescribeSnapshotAttributeOutcome;
        typedef Utils::Outcome<DescribeSnapshotsResponse, Client::AWSError<EC2Errors>> DescribeSnapshotsOutcome;
        typedef Utils::Outcome<DescribeSpotDatafeedSubscriptionResponse, Client::AWSError<EC2Errors>> DescribeSpotDatafeedSubscriptionOutcome;
        typedef Utils::Outcome<DescribeSpotFleetInstancesResponse, Client::AWSError<EC2Errors>> DescribeSpotFleetInstancesOutcome;
        typedef Utils::Outcome<DescribeSpotFleetRequestHistoryResponse, Client::AWSError<EC2Errors>> DescribeSpotFleetRequestHistoryOutcome;
        typedef Utils::Outcome<DescribeSpotFleetRequestsResponse, Client::AWSError<EC2Errors>> DescribeSpotFleetRequestsOutcome;
        typedef Utils::Outcome<DescribeSpotInstanceRequestsResponse, Client::AWSError<EC2Errors>> DescribeSpotInstanceRequestsOutcome;
        typedef Utils::Outcome<DescribeSpotPriceHistoryResponse, Client::AWSError<EC2Errors>> DescribeSpotPriceHistoryOutcome;
        typedef Utils::Outcome<DescribeSubnetsResponse, Client::AWSError<EC2Errors>> DescribeSubnetsOutcome;
        typedef Utils::Outcome<DescribeTagsResponse, Client::AWSError<EC2Errors>> DescribeTagsOutcome;
        typedef Utils::Outcome<DescribeVolumeAttributeResponse, Client::AWSError<EC2Errors>> DescribeVolumeAttributeOutcome;
        typedef Utils::Outcome<DescribeVolumeStatusResponse, Client::AWSError<EC2Errors>> DescribeVolumeStatusOutcome;
        typedef Utils::Outcome<DescribeVolumesResponse, Client::AWSError<EC2Errors>> DescribeVolumesOutcome;
        typedef Utils::Outcome<DescribeVpcAttributeResponse, Client::AWSError<EC2Errors>> DescribeVpcAttributeOutcome;
        typedef Utils::Outcome<DescribeVpcClassicLinkResponse, Client::AWSError<EC2Errors>> DescribeVpcClassicLinkOutcome;
        typedef Utils::Outcome<DescribeVpcEndpointServicesResponse, Client::AWSError<EC2Errors>> DescribeVpcEndpointServicesOutcome;
        typedef Utils::Outcome<DescribeVpcEndpointsResponse, Client::AWSError<EC2Errors>> DescribeVpcEndpointsOutcome;
        typedef Utils::Outcome<DescribeVpcPeeringConnectionsResponse, Client::AWSError<EC2Errors>> DescribeVpcPeeringConnectionsOutcome;
        typedef Utils::Outcome<DescribeVpcsResponse, Client::AWSError<EC2Errors>> DescribeVpcsOutcome;
        typedef Utils::Outcome<DescribeVpnConnectionsResponse, Client::AWSError<EC2Errors>> DescribeVpnConnectionsOutcome;
        typedef Utils::Outcome<DescribeVpnGatewaysResponse, Client::AWSError<EC2Errors>> DescribeVpnGatewaysOutcome;
        typedef Utils::Outcome<DetachClassicLinkVpcResponse, Client::AWSError<EC2Errors>> DetachClassicLinkVpcOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DetachInternetGatewayOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DetachNetworkInterfaceOutcome;
        typedef Utils::Outcome<DetachVolumeResponse, Client::AWSError<EC2Errors>> DetachVolumeOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DetachVpnGatewayOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DisableVgwRoutePropagationOutcome;
        typedef Utils::Outcome<DisableVpcClassicLinkResponse, Client::AWSError<EC2Errors>> DisableVpcClassicLinkOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DisassociateAddressOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> DisassociateRouteTableOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> EnableVgwRoutePropagationOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> EnableVolumeIOOutcome;
        typedef Utils::Outcome<EnableVpcClassicLinkResponse, Client::AWSError<EC2Errors>> EnableVpcClassicLinkOutcome;
        typedef Utils::Outcome<GetConsoleOutputResponse, Client::AWSError<EC2Errors>> GetConsoleOutputOutcome;
        typedef Utils::Outcome<GetPasswordDataResponse, Client::AWSError<EC2Errors>> GetPasswordDataOutcome;
        typedef Utils::Outcome<ImportImageResponse, Client::AWSError<EC2Errors>> ImportImageOutcome;
        typedef Utils::Outcome<ImportInstanceResponse, Client::AWSError<EC2Errors>> ImportInstanceOutcome;
        typedef Utils::Outcome<ImportKeyPairResponse, Client::AWSError<EC2Errors>> ImportKeyPairOutcome;
        typedef Utils::Outcome<ImportSnapshotResponse, Client::AWSError<EC2Errors>> ImportSnapshotOutcome;
        typedef Utils::Outcome<ImportVolumeResponse, Client::AWSError<EC2Errors>> ImportVolumeOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ModifyImageAttributeOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ModifyInstanceAttributeOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ModifyNetworkInterfaceAttributeOutcome;
        typedef Utils::Outcome<ModifyReservedInstancesResponse, Client::AWSError<EC2Errors>> ModifyReservedInstancesOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ModifySnapshotAttributeOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ModifySubnetAttributeOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ModifyVolumeAttributeOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ModifyVpcAttributeOutcome;
        typedef Utils::Outcome<ModifyVpcEndpointResponse, Client::AWSError<EC2Errors>> ModifyVpcEndpointOutcome;
        typedef Utils::Outcome<MonitorInstancesResponse, Client::AWSError<EC2Errors>> MonitorInstancesOutcome;
        typedef Utils::Outcome<MoveAddressToVpcResponse, Client::AWSError<EC2Errors>> MoveAddressToVpcOutcome;
        typedef Utils::Outcome<PurchaseReservedInstancesOfferingResponse, Client::AWSError<EC2Errors>> PurchaseReservedInstancesOfferingOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> RebootInstancesOutcome;
        typedef Utils::Outcome<RegisterImageResponse, Client::AWSError<EC2Errors>> RegisterImageOutcome;
        typedef Utils::Outcome<RejectVpcPeeringConnectionResponse, Client::AWSError<EC2Errors>> RejectVpcPeeringConnectionOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ReleaseAddressOutcome;
        typedef Utils::Outcome<ReplaceNetworkAclAssociationResponse, Client::AWSError<EC2Errors>> ReplaceNetworkAclAssociationOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ReplaceNetworkAclEntryOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ReplaceRouteOutcome;
        typedef Utils::Outcome<ReplaceRouteTableAssociationResponse, Client::AWSError<EC2Errors>> ReplaceRouteTableAssociationOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ReportInstanceStatusOutcome;
        typedef Utils::Outcome<RequestSpotFleetResponse, Client::AWSError<EC2Errors>> RequestSpotFleetOutcome;
        typedef Utils::Outcome<RequestSpotInstancesResponse, Client::AWSError<EC2Errors>> RequestSpotInstancesOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ResetImageAttributeOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ResetInstanceAttributeOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ResetNetworkInterfaceAttributeOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> ResetSnapshotAttributeOutcome;
        typedef Utils::Outcome<RestoreAddressToClassicResponse, Client::AWSError<EC2Errors>> RestoreAddressToClassicOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> RevokeSecurityGroupEgressOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> RevokeSecurityGroupIngressOutcome;
        typedef Utils::Outcome<RunInstancesResponse, Client::AWSError<EC2Errors>> RunInstancesOutcome;
        typedef Utils::Outcome<StartInstancesResponse, Client::AWSError<EC2Errors>> StartInstancesOutcome;
        typedef Utils::Outcome<StopInstancesResponse, Client::AWSError<EC2Errors>> StopInstancesOutcome;
        typedef Utils::Outcome<TerminateInstancesResponse, Client::AWSError<EC2Errors>> TerminateInstancesOutcome;
        typedef Utils::Outcome<NoResult, Client::AWSError<EC2Errors>> UnassignPrivateIpAddressesOutcome;
        typedef Utils::Outcome<UnmonitorInstancesResponse, Client::AWSError<EC2Errors>> UnmonitorInstancesOutcome;
    ...
    public:
      typedef Aws::Client::AWSXMLClient BASECLASS;
        ...
        */
        ...
        /*
            <p>Deletes the data feed for Spot Instances. For more information, see <a href="http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-data-feeds.html">Spot Instance Data Feed</a> in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
        */
        ...
        */
        ...
        /*
            <p>Creates a Spot fleet request.</p> <p>For more information, see <a href="http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-fleet.html">Spot Fleets</a> in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>
        */
